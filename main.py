...
async def freccetta(target):
    sonno.append(target)
    print(sonno)
    await bot.send_message(target, "Sei stato colpito da una freccetta tranquillante e sei caduto in un sonno profondo!")
